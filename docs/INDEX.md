...
|----------|---------------------|
| [Getting Started](tutorials/getting-started.md) | Install cargo-cicd, run `workspace doctor`, check status, and publish a crate — a complete first session |
| [First Playground Run](tutorials/first-playground-run.md) | Explore cargo-cicd commands in a scratch workspace without touching your real project |
| [Combinatorial Maximalism](tutorials/combinatorial-maximalism.md) | Walk through the combinatorial test strategy by building a small feature that exercises multiple verbs together |
